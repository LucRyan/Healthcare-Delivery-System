...
import Final.Ryan.Sqs.Demo.AlertActivity;
    	...
    	submitButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					String username = info.getString(Welcome.USER_NAME);
					SimpleQueue.sendMessage(queueSpinner.getSelectedItem().toString(), username+ ": "+messageInput.getText().toString());
					finish();
				} catch (Throwable e) {
    				setStackAndPost(e);
				}
